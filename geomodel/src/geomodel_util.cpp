...
static char *GeomodelTypeName[] = {"Unknown", "MESH", "SURFACE", "ANYTYPE"};
 ...
 *
 */
struct GeomodelType_struct geomodel_struct_array[] = {{"MESH", MESHTYPE},
						      {"SURFACE", SURFACETYPE},
						      {"ANYTYPE", ANYTYPE}};
 ...
 */
int
geomodel_type_from_string(const char *str, uint8_t *type)
{
	char *tmpstr;
 ...
 */
const char *
geomodel_type_name(uint8_t type)
{
	if (type > 15)
	{
		/* assert(0); */
 ...
 */
void
Hex2Char(unsigned char src, unsigned char *dst)
{
 ...
 */
unsigned char
_Char2Hex(const unsigned char c)
{
...
unsigned char
Char2Hex(const unsigned char *c)
{
